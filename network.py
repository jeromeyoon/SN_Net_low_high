...
class networks(object):
	...
	tf.get_variable_scope().reuse_variables()
	g_bn0 = batch_norm(self.batch_size,name='g_bn0')
        g_nir0 =lrelu(g_bn0(conv2d(nir,self.df_dim*2,name='g_nir0'),train=False))
	g_bn1 = batch_norm(self.batch_size,name='g_bn1')
        g_nir1 =lrelu(g_bn1(conv2d(g_nir0,self.df_dim*4,name='g_nir1'),train=False))
	g_bn2 = batch_norm(self.batch_size,name='g_bn2')
        g_nir2 =lrelu(g_bn2(conv2d(g_nir1,self.df_dim*4,name='g_nir2'),train=False))
	g_bn3 = batch_norm(self.batch_size,name='g_bn4')
        g_nir3 =lrelu(g_bn3(conv2d(g_nir2,self.df_dim*2,name='g_nir3'),train=False))
        g_nir4 =conv2d(g_nir3,3,name='g_nir4')
