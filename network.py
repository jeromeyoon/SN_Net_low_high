...
class networks(object):
	...
	g_bn3 = batch_norm(self.batch_size,name='low_g_bn4')
   ...
   def generator_high(self,nir):
	...
	g_bn3 = batch_norm(self.batch_size,name='high_g_bn4')
	...
	d_bn3 = batch_norm(self.batch_size,name='low_d_bn3')
        h3 = lrelu(d_bn3(conv2d(h2, self.df_dim*8, d_h=2,d_w=2,name='low_d_h3_conv'))) #output size: 4x4
	...
	d_bn3 = batch_norm(self.batch_size,name='high_d_bn3')
        h3 = lrelu(d_gn3(conv2d(h2, self.df_dim*8, d_h=2,d_w=2,name='high_d_h3_conv'))) #output size: 4x4
        #h4 = conv2d(h3,1, k_h=1,k_w=1,name='d_h4_conv') #output size: 4x4
